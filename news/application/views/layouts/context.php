...
<meta name="description" content="<?php if( isset( $description) ) echo $description . cutstr( trim(  strip_tags( $article['post_content'] ) ) , 200 , '');?>" />
...
<div class="row-fluid">
  ...
  <div class="span9">
    ...
    <p class="pull-right"><wb:share-button appkey="342fqh" addition="full" type="button" ralateUid="3806766242"></wb:share-button></p>
  ...
  <div class="span3">
    ...
    <div class="panel panel-info">
      <div class="panel-heading">最高点击</div>

      <div class="panel-body">
        <?php $this->load->module('home/default/high_click');?>
      </div>
