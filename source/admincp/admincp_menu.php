...
$menu['client'] = array(
	//array('menu_client_main' , 'client_main'),
	array('menu_client_config' , 'client_config'),
	array('menu_client_member' , 'client_member'),
	array('menu_client_order' , 'client_order'),
	array('menu_client_receipt' , 'client_receipt'),
	array('menu_client_cuser' , 'client_cuser'),
