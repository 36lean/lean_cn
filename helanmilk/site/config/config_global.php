...
$_config['db']['1']['dbuser'] = 'ultrax_f';
$_config['db']['1']['dbpw'] = 'mwang8866';
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'nfkw_';
$_config['cookie']['cookiedomain'] = '';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = '502d2fwAXS1SfrRO';
