<?php
loadcache('plugin');
$pluginid=DB::result_first("SELECT pluginid FROM ".DB::table('common_plugin')." where identifier='nimba_security'");
require_once DISCUZ_ROOT.'./source/discuz_version.php';
if(DISCUZ_VERSION=='X2') $filepath=DISCUZ_ROOT.'./data/cache/cache_nimba_security_time.php';
if(DISCUZ_VERSION=='X2.5'||DISCUZ_VERSION=='X3 Beta'||DISCUZ_VERSION=='X3') $filepath=DISCUZ_ROOT.'./data/sysdata/cache_nimba_security_time.php';
...
if($_POST){
	...
	if(strtolower(CHARSET) == 'utf-8') $tag=auto_charset($tag,'GB2312','UTF-8');
	$wid=array();
	$bid=array();
	$del=array();
