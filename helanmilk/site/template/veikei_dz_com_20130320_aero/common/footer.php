...
<!--{if empty($topic) || ($topic[usefooter])}-->
	...
	<div id="ft" class="wp cl">
		<div id="flk" class="y">
			<p>
				...
				<!--{loop $_G['setting']['footernavs'] $nav}--><!--{if $nav['available'] && ($nav['type'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1)) ||
						!$nav['type'] && ($nav['id'] == 'stat' && $_G['group']['allowstatdata'] || $nav['id'] == 'report' && $_G['uid'] || $nav['id'] == 'archiver' || $nav['id'] == 'mobile'))}-->$nav[code]<span class="pipe">|</span><!--{/if}--><!--{/loop}-->
      ...
      <p class="xs0">&copy; 2001-2012 <a href="http://www.comsenz.com" target="_blank"> Comsenz Inc.</a> Template By <a href="http://www.veikei.com" target="_blank"> 【未来科技】【www.veikei.com】 设计</a></p>
		</div>
		<!--{eval updatesession();}-->
