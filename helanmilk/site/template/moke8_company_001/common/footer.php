...
<!--{if empty($topic) || ($topic[usefooter])}-->
	...
	<footer>
         <!--{subtemplate common/footer_nav}-->
         <div class="footer-copyright clearfix">
            <div class="center-wrap clearfix">
               <div class="foot-copy">
                  <p>Powered by <strong><a href="http://www.discuz.net" target="_blank">Discuz!</a></strong> <em>$_G['setting']['version']</em><!--{if !empty($_G['setting']['boardlicensed'])}--> <a href="http://license.comsenz.com/?pid=1&host=$_SERVER[HTTP_HOST]" target="_blank">Licensed</a><!--{/if}--> Template by <a href="http://www.moke8.com" target="_blank">moke8</a></p>
               </div>
               <!-- END foot-copy -->
               <a class="link-top" id="scroll_to_top" href="#">Top</a>
               <ul class="footer-nav">
                 <!--{loop $_G['setting']['footernavs'] $nav}--><!--{if $nav['available'] && ($nav['type'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1)) ||
						!$nav['type'] && ($nav['id'] == 'stat' && $_G['group']['allowstatdata'] || $nav['id'] == 'report' && $_G['uid'] || $nav['id'] == 'archiver' || $nav['id'] == 'mobile'))}--><li>$nav[code]</li><!--{/if}--><!--{/loop}-->
               </ul>
            </div>
            <!-- END center-wrap -->
         </div>
...
<!--{/if}-->
 <script type="text/javascript" src="template/moke8_company_001/moke8/js/custom-main.js"></script>
      <script type="text/javascript" src="template/moke8_company_001/moke8/js/jquery.prettyPhoto.js"></script>
      <script type="text/javascript" src="template/moke8_company_001/moke8/js/slides.min.jquery.js"></script>
      <script type="text/javascript" src="template/moke8_company_001/moke8/js/jquery.cycle.all.min.js"></script>
      <script type="text/javascript" src="template/moke8_company_001/moke8/js/jquery.easing.1.3.js"></script>
      <script type="text/javascript">
