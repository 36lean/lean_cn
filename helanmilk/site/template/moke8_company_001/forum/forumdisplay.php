...
<section class="small_banner">
   <div class="center-wrap">
      ...
      <a href="./" title="{lang homepage}">$_G[setting][bbname]</a> ¡ú <a href="forum.php"{if $_G['setting']['forumjump']} id="fjump" onmouseover="delayShow(this, 'showForummenu($_G[fid])');" class="showmenu"{/if}>{$_G[setting][navs][2][navname]}</a>$navigation
