<?php echo 'Ä§¿Í°É³öÆ·-www.moke8.com';exit;?>
...
<section class="small_banner">
   <div class="center-wrap">
      <p class="page-banner-heading">$_G[forum_thread][short_subject]</p>
      ...
      <a href="./" title="{lang homepage}">$_G[setting][bbname]</a> ¡ú <a href="forum.php"{if $_G['setting']['forumjump']} id="fjump" onmouseover="delayShow(this, 'showForummenu($_G[fid])');" class="showmenu" {/if}>{$_G[setting][navs][2][navname]}</a>$navigation <em>&rsaquo;</em> <a href="forum.php?mod=viewthread&tid=$_G[tid]">$_G[forum_thread][short_subject]</a>
