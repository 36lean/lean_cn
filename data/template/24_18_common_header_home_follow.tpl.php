...
0
|| checktplrefresh('./template/tpl/common/header.htm', './template/tpl/common/header_common.htm', 1380525994, '18', './data/template/24_18_common_header_home_follow.tpl.php', './template/tpl', 'common/header_home_follow')
;?>
﻿<!DOCTYPE html>
