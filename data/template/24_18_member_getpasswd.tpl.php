<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('getpasswd');
0
|| checktplrefresh('./template/tpl/member/getpasswd.htm', './template/tpl/common/header.htm', 1381987636, '18', './data/template/24_18_member_getpasswd.tpl.php', './template/tpl', 'member/getpasswd')
|| checktplrefresh('./template/tpl/member/getpasswd.htm', './template/tpl/common/footer.htm', 1381987636, '18', './data/template/24_18_member_getpasswd.tpl.php', './template/tpl', 'member/getpasswd')
|| checktplrefresh('./template/tpl/member/getpasswd.htm', './template/tpl/common/header_common.htm', 1381987636, '18', './data/template/24_18_member_getpasswd.tpl.php', './template/tpl', 'member/getpasswd')
;?>
﻿<!DOCTYPE html>
...
<p class="lead"><input type="text" readonly="readonly" value="<?php echo $member['username'];?>" /></p>

<p class="lead">新密码: </p>

<p class="lead"><input type="password" name="newpasswd1" size="25" class="input-medium" /></p>

<p class="lead">确认密码:</p>

<p class="lead"><input type="password" name="newpasswd2" size="25" class="input-medium" /></p>

</div>

<p>
<button class="btn btn-success" type="submit" name="getpwsubmit" value="true">提交</button>
</p>
</form>
</div>
...
<div class="hero-unit">
<blockquote>
没有帐号？<a href="member.php?mod=<?php echo $_G['setting']['regname'];?>"><?php echo $_G['setting']['reglinkname'];?></a>
</blockquote>
</div>
