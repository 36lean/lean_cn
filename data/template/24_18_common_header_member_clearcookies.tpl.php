...
0
|| checktplrefresh('./template/tpl/common/header.htm', './template/tpl/common/header_common.htm', 1383038517, '18', './data/template/24_18_common_header_member_clearcookies.tpl.php', './template/tpl', 'common/header_member_clearcookies')
;?>
﻿<!DOCTYPE html>
<html lang="en">
<head>
