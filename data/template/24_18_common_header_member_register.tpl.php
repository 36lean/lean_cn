...
0
|| checktplrefresh('./template/tpl/common/header.htm', './template/tpl/common/header_common.htm', 1383917000, '18', './data/template/24_18_common_header_member_register.tpl.php', './template/tpl', 'common/header_member_register')
;?>
﻿<!DOCTYPE html>
<html lang="en">
<head>
