...
0
|| checktplrefresh('./template/tpl/common/header.htm', './template/tpl/common/header_common.htm', 1382971135, '18', './data/template/24_18_common_header_examination_mytest.tpl.php', './template/tpl', 'common/header_examination_mytest')
;?>
﻿<!DOCTYPE html>
<html lang="en">
<head>
