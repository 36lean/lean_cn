...
<div class="container" align="center">
  <div id="myCarousel" class="carousel slide">  
    ...
    <div class="carousel-inner">    
      <div class="active item">
        <a href="routing.php" target="_blank"><img src="http://www.36lean.com/static/mot/banner.jpg"  /></a>
      </div>

      <div class="item">
        <a href="routing.php" target="_blank"><img src="http://www.36lean.com/static/mot/banner2.jpg"  /></a>
      </div>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
      <div class="txt span4">
          <img src="http://36lean.com/static/mot/yun-step1.png">
            <h3>注册账号</h3>
        </div>

        <div class="txt span4">
          <img src="http://36lean.com/static/mot/yun-step2.png">
          <h3>购买课程</h3>
        </div>
        <div class="txt span4">
          <img src="http://36lean.com/static/mot/yun-step3.png">
          <h3>开始学习</h3>
        </div>
    </div>
  </div>
