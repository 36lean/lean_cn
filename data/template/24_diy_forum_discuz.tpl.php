...
0
|| checktplrefresh('./template/tpl/forum/discuz.htm', './template/tpl/common/header.htm', 1380525976, 'diy', './data/template/24_diy_forum_discuz.tpl.php', './template/tpl', 'forum/discuz')
|| checktplrefresh('./template/tpl/forum/discuz.htm', './template/tpl/common/footer.htm', 1380525976, 'diy', './data/template/24_diy_forum_discuz.tpl.php', './template/tpl', 'forum/discuz')
|| checktplrefresh('./template/tpl/forum/discuz.htm', './template/tpl/common/header_common.htm', 1380525976, 'diy', './data/template/24_diy_forum_discuz.tpl.php', './template/tpl', 'forum/discuz')
;?>
﻿<!DOCTYPE html>
...
<?php if($_G['group']['radminid'] == 1) { ?><?php helper_manyou::checkupdate();?><?php } ?>
