...
0
|| checktplrefresh('./template/tpl/common/header.htm', './template/tpl/common/header_common.htm', 1382971142, '18', './data/template/24_18_common_header_examination_more.tpl.php', './template/tpl', 'common/header_examination_more')
;?>
﻿<!DOCTYPE html>
<html lang="en">
<head>
