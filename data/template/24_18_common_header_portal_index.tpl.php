...
0
|| checktplrefresh('./template/tpl/common/header.htm', './template/tpl/common/header_common.htm', 1381995262, '18', './data/template/24_18_common_header_portal_index.tpl.php', './template/tpl', 'common/header_portal_index')
;?>
﻿<!DOCTYPE html>
