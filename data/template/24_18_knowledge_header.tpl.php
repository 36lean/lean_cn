...
0
|| checktplrefresh('./template/tpl/knowledge/header.htm', './template/tpl/common/header.htm', 1377953908, '18', './data/template/24_18_knowledge_header.tpl.php', './template/tpl', 'knowledge/header')
|| checktplrefresh('./template/tpl/knowledge/header.htm', './template/tpl/common/header_common.htm', 1377953908, '18', './data/template/24_18_knowledge_header.tpl.php', './template/tpl', 'knowledge/header')
;?>
﻿<!DOCTYPE html>
...
<div class="container"><script src="static/mot/jquery.esn.autobrowse.js" type="text/javascript"></script>
<!--[if ! IE]>
<script src="static/mot/jstorage.js" type="text/javascript"></script>
<![endif]-->
<div class="container-fluid ">
<div class="row-fluid mot-block-b">

<div class="span2">
<a href="knowledge.php" title="36lean.com问答社区">
<img style="width:150px;" src="static/mot/knowledge.jpeg" />
</a>
...
<h1>问答社区
    		<h5><small>知识就是力量 knowledge is power</small></h5>
            </h1>

        <!--
    	<form class="pull-right" action="knowledge.php" method="post">
    		<div class="input-append">
    			<input id="tags2" name="keyword" type="text" class="span8">
                <button name="findout" type="submit" class="btn">查找问题</button>
                <br />
    		</div>
            <script>
    ...
    <div class="container" align="center">
        <ul class="nav nav-pills">
            <li class="<?php if($mod === 'home') { ?>active<?php } ?>">
                <a href="knowledge.php">首页</a>
            </li>
            
            <li class="<?php if($mod === 'question') { ?>active<?php } ?>">
                <a href="knowledge.php?mod=question">我要提问</a>
            </li>

            <li class="<?php if($mod === 'answer') { ?>active<?php } ?>">
                <a href="knowledge.php?mod=answer">我要回答</a>
            </li>

            <li class="<?php if($mod === 'hottopic') { ?>active<?php } ?>">
                <a href="knowledge.php?mod=hottopic">热门话题</a>
            </li>

            <li class="<?php if($mod === 'repository') { ?>active<?php } ?>">
                <a href="knowledge.php?mod=repository">资料库</a>
            </li>
        </ul>
    </div>
...
<div class="row-fluid">
  <div class="span3">
  	 <?php include template('knowledge/left_side'); ?>  </div>
