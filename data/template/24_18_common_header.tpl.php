...
0
|| checktplrefresh('./template/tpl/common/header.htm', './template/tpl/common/header_common.htm', 1382764985, '18', './data/template/24_18_common_header.tpl.php', './template/tpl', 'common/header')
;?>
﻿<!DOCTYPE html>
<html lang="en">
<head>
