...
0
|| checktplrefresh('./template/tpl/common/header.htm', './template/tpl/common/header_common.htm', 1382971139, '18', './data/template/24_18_common_header_examination_library.tpl.php', './template/tpl', 'common/header_examination_library')
;?>
﻿<!DOCTYPE html>
<html lang="en">
<head>
