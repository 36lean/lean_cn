...
0
|| checktplrefresh('./template/tpl/common/header.htm', './template/tpl/common/header_common.htm', 1382971110, '18', './data/template/24_18_common_header_examination_enroll.tpl.php', './template/tpl', 'common/header_examination_enroll')
;?>
﻿<!DOCTYPE html>
<html lang="en">
<head>
