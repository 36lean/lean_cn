...
0
|| checktplrefresh('./template/tpl/common/header.htm', './template/tpl/common/header_common.htm', 1385641799, '18', './data/template/24_18_common_header_lesson_pages_list.tpl.php', './template/tpl', 'common/header_lesson_pages_list')
;?>
﻿<!DOCTYPE html>
<html lang="en">
<head>
...
<li><a href="read.php?title=product">产品版本</a></li>
          	...
          	<li <?php if($_GET['title'] === 'leanshop') { ?>class="active"<?php } ?>><a href="<?php echo $_G['site_url'];?>read.php?title=leanshop"><i class="icon-shopping-cart"></i> 精企商城 </a></li>
