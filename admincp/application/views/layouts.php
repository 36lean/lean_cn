...
<head>
    ...
    <?php global $constant;?>
    <title>
        精益云管理 - <?php if( $this->uri->segment(1)) echo $constant[$this->uri->segment(1)]; else echo $constant['welcome']?>
...
<div class="container-fluid">
    ...
    <div class="btn-group pull-right" >
        <a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
            <i class="icon-user"></i><span class="hidden-phone"> 身份</span>
...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span12">
            ...
            <ul class="nav nav-tabs">
                <li class="nav-header hidden-tablet">CRM</li>           
                <?php if( in_array(  'mailer', $user['resource']) || in_array(  'c_mailer', $user['resource'])){?>
                <li <?php if( 'mailer' === $this->uri->segment(1)){?>class="active"<?php }?>>
                    <a class="ajax-link" href="<?php echo base_url();?>index.php/mailer">邮件 <i class="icon-angle-down"></i></a>
                </li>
                <?php }?>

                <?php if( in_array(  'marketing', $user['resource']) || in_array(  'c_mailer', $user['resource'])){?>
                <li <?php if( 'marketing' === $this->uri->segment(1)){?>class="active"<?php }?>>
                    <a class="ajax-link" href="<?php echo base_url();?>index.php/marketing">营销 <i class="icon-angle-down"></i></a>
                </li>
                <?php }?>
                
                <li class="nav-header hidden-tablet">网站管理</li>
                <?php if( in_array(  'client', $user['resource']) || in_array(  'c_mailer', $user['resource'])){?>
                <li <?php if( 'client' === $this->uri->segment(1)){?>class="active"<?php }?>>
                    <a class="ajax-link" href="<?php echo base_url();?>index.php/client">客户 <i class="icon-angle-down"></i></a>
                </li>
                 <?php }?>
                    
                <?php if( in_array(  'course', $user['resource']) || in_array(  'c_course', $user['resource'])){?>
                <li <?php if( 'course' === $this->uri->segment(1)){?>class="active"<?php }?>>
                    <a class="ajax-link" href="<?php echo base_url();?>index.php/course">课程 <i class="icon-angle-down"></i></a>
                </li>
                <?php }?>

                <?php if( in_array(  'website', $user['resource']) || in_array(  'c_website', $user['resource'])){?>
                <li <?php if( 'website' === $this->uri->segment(1)){?>class="active"<?php }?>>
                    <a class="ajax-link" href="<?php echo base_url();?>index.php/website">网站 <i class="icon-angle-down"></i></a>
                </li>
                <?php }?>

                <?php if( in_array(  'review', $user['resource']) || in_array(  'c_review', $user['resource'])){?>
                <li <?php if( 'review' === $this->uri->segment(1)){?>class="active"<?php }?>>
                    <a class="ajax-link" href="<?php echo base_url();?>index.php/review">内容审核 <i class="icon-angle-down"></i></a>
                </li>
                <?php }?>
        
                <?php if( in_array(  'statistic', $user['resource']) || in_array(  'c_statistic', $user['resource'])){?>
                <li <?php if( 'statistic' === $this->uri->segment(1)){?>class="active"<?php }?>>
                    <a class="ajax-link" href="<?php echo base_url();?>index.php/statistic">分析/统计 <i class="icon-angle-down"></i></a>
                </li>
                <?php }?>

                <!--
                <?php if( in_array(  'bugtrack', $user['resource']) || in_array(  'c_bugtrack', $user['resource'])){?>
                <li <?php if( 'bugtrack' === $this->uri->segment(1)){?>class="active"<?php }?>>
                    <a class="ajax-link" href="<?php echo base_url();?>index.php/bugtrack">Bug提交 <i class="icon-angle-down"></i></a>
                </li>
                <?php }?>
                -->
                
                <?php if( in_array(  'permission', $user['resource']) || in_array(  'c_permission', $user['resource'])){?>
                <li class="nav-header hidden-tablet">后台设置</li>
                <li <?php if( 'permission' === $this->uri->segment(1)){?>class="active"<?php }?>>
                    <a class="ajax-link" href="<?php echo base_url();?>index.php/permission">权限设置 <i class="icon-angle-down"></i></a>
                </li>
                <?php }?>
            </ul>
    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <ul class="nav nav-pills">
                ...
                ?>
                <li <?php if( ($this->uri->segment(2) === $n) || (!$this->uri->segment(2) && $n==='index') ) echo 'class="active"';?>><a href="<?php echo base_url()?>index.php/<?php echo $this->uri->segment(1)?>/<?php echo $n;?>"><?php echo $constant["$n"];?></a></li>
                <?php
                }?>
            </ul>
        </div>
    ...
    <ul class="breadcrumb">
        <li><i class="icon-home icon-reverse"></i> <a href="<?php echo base_url()?>index.php">首页</a></li>
        <?php if( $this->uri->segment(1)){?>
            <li> <span class="divider">/</span><a href="<?php echo base_url() . 'index.php/' .$this->uri->segment(1);?>">
        <?php echo $constant[$this->uri->segment(1)];?></a> </li><?php }?>
        
        <?php if( $this->uri->segment(2)){?>
            <li class="active"><span class="divider">/</span> <?php echo $constant[$this->uri->segment(2)];?></li>
        <?php }?>
    </ul>
