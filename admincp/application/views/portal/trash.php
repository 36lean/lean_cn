...
<div class="row">
	...
	<div class="span3">
		...
		<label><strong>彻底删除新闻</strong></label>
		<div class="controls">
			<input class="btn btn-primary" type="submit" name="reback" value="还原" />
			<input class="btn btn-danger" type="submit" name="clean" value="删除" />
		</div>
		</div>
