...
<div style="margin:20px;">
	...
	<div class="btn-group">
    	<a href="<?php echo site_url('sale/index');?>" class="btn btn-primary">全部联系人 [ <?php echo $sum;?> ] 个</a>
    	<a href="<?php echo site_url('sale/remind');?>" class="btn btn-primary">今日提醒 [ <?php echo $remind_num;?> ] 个</a>
	</div>
...
<table class="mot-table">
	...
	<tr data-modal="<?php echo $one['id'];?>">
		...
		<td>
			<input class="datetimepicker" rel="<?php echo $one['id'];?>" type="text" value="" />
		</td>
