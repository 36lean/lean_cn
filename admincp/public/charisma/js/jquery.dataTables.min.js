 ...
 (function(i, V, l, n) {
    var j = function(e) {
        ...
        function r(a, b, c) {
            ...
            a.oFeatures.bSort || (b.bSortable = !1); ! b.bSortable || -1 == i.inArray("asc", b.asSorting) && -1 == i.inArray("desc", b.asSorting) ? (b.sSortingClass = 
        ...
        function H(a, b) {
            ...
            g._aData = c;
            a.aoData.push(g);
            for (var f, g = 0, h = a.aoColumns.length; g < h; g++) c = a.aoColumns[g],
        ...
        function ua(a) {
            ...
            for (e = a.aoColumns.length; g < e; g++) {
                ...
                if (f || s || o || !k) {
                    ...
                    s && (r = R(a, b, g), n.innerHTML = 
                    r, m.bUseRendered && I(a, b, g, r)),
        ...
        function ta(a) {
            ...
            if ("string" === typeof a && -1 != a.indexOf(".")) {
                var b = a.split(".");
                return function(a, d) {
                    for (var g = 0, f = b.length - 1; g < f; g++) a[b[g]] === n && (a[b[g]] = {}),
                    a = a[b[g]];
                    a[b[b.length - 1]] = d
                }
            }
        ...
        function y(a) {
            ...
            if ( - 1 !== i.inArray(!1, b)) F(a, !1);
                ...
                f = c.sLoadingRecords: c.sEmptyTable && 0 === a.fnRecordsTotal() && (f = c.sEmptyTable),
        ...
        function Ha(a, b, c, d, g, f) {
            if ("" !== b) for (var h = 0, b = ka(b, d, g, f), d = a.aiDisplay.length - 1; 0 <= d; d--) g = la(w(a, a.aiDisplay[d], c, "filter"), a.aoColumns[c].sType),
            b.test(g) || (a.aiDisplay.splice(d, 
            1), h++)
        }
        ...
        function aa(a) {
            ...
            200);
                ...
                c), a.fnServerData.call(a.oInstance, a.sAjaxSource, c, 
                function(c) {
        ...
        function P(a, b) {
            ...
            if (!a.oFeatures.bServerSide && (0 !== a.aaSorting.length || null !== a.aaSortingFixed)) {
                ...
                for (d = r.length; c < d; c++) for (g = 0; g < q; g++) {
                    ...
                    f = k[(f ? f: "string") + "-pre"],
                    r[c]._aSortData[G[h]] = f ? f(w(a, c, G[h], "sort")) : 
                    w(a, c, G[h], "sort")
                }
        ...
        this.fnDestroy = function(a) {
            ...
            b.aoData[g].nTr && d.appendChild(b.aoData[g].nTr); ! 0 === b.oFeatures.bAutoWidth && (b.nTable.style.width = q(b.sDestroyWidth));
        ...
        this.fnUpdate = function(a, b, c, d, e) {
            ...
            f.asDataSearch[c] = 
            ma(f, X(f, b, "filter")); (e === n || e) && k(f); (d === n || d) && $(f);
            return 0
        };
        ...
        return this.each(function() {
            ...
            if ("table" != this.nodeName.toLowerCase()) E(null, 0, "Attempted to initialise DataTables on a node which is not a table: " + this.nodeName);
                ...
                i.getJSON(h.oLanguage.sUrl, null, 
                function(a) {
                    oa(a);
                ...
                a = 0;
                for (b = 
                d.length; a < b; a++) e.saved_aoColumns !== n && e.saved_aoColumns.length == b && (null === d[a] && (d[a] = {}), d[a].bVisible = e.saved_aoColumns[a].bVisible),
                o(h, c ? c[a] : null);
    ...
    j.defaults = {
        ...
        aaSorting: [[0, "asc"]],
        aaSortingFixed: null,
        aLengthMenu: [500,200,100, 50, 25, 10 ,5],
        aoColumns: null,
        aoColumnDefs: null,
        aoSearchCols: [],
        ...
        fnFormatNumber: function(e) {
            if (1E3 > e) return e;
            for (var i = e + "", e = i.split(""), j = "", i = i.length, k = 0; k < i; k++) 0 === k % 3 && 0 !== k && (j = this.oLanguage.sInfoThousands + j),
            j = e[i - k - 1] + j;
            return j
        },
