...
if( isset( $_POST['_username'])) {
	$user = C::t('b_request')->did_username_exist( $_POST['_username']);
	echo $user['count'];
}else if( isset( $_POST['_email'])) {
	$user = C::t('b_request')->did_email_exist( $_POST['_email']);
	echo $user['count'];
}else if( isset( $_POST['_mobile'])) {
	$user = C::t('b_request')->did_phone_exist( $_POST['_mobile']);
	echo (bool)$user['count'];
}
